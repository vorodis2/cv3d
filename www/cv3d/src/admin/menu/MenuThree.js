...
export  function MenuThree(menu, fun) {  
    ...
    this.menuTObj = new MenuThreeObj(this, this.w.content, function(s, p, p1){
        trace('menuTObj fun', self, s, p, p1)
        self.save()
    })
    ...
    this.gallery=new GalleryXZKKK(this.w, this.otstup, yy+32,function(){
...
export  function MenuThreeObj(par, _dCont, fun) {  
    ...
    this.array.push(this.label3 = new DLabel(this.dCont, xx, yy, 'name: '))
    this.array.push(this.inputName = new DInput(this.dCont, this.labelOtstup, yy, 'name', function(){
        self.obj.name = this.value;
        self.fun('name', this.value)
    }))
    this.inputName.width = 145;
    yy += this.inputName.height + this.otstup;


    this.array.push(this.tId = new DComboBox(this.dCont, xx, yy, '', function(){
        self.obj.tId = this.index;
        self.fun('tId', this.index)
    }))
    this.tId.width = 145+this.labelOtstup;
    var aaa = []
    ...
    this.tId.array = aaa;
    yy += this.tId.height + this.otstup;
    ...
    this.createInput = function(_arr, _fun){
        for (var i = 0; i < 3; i++) {
            this.array.push(_arr[i]= new DInput(this.dCont, this.otstup+15+(wxz+this.otstup)*i, yyy," ", _fun));
            _arr[i].idArr=i
            _arr[i].width=wxz
    ...
    this.array.push(new DLabel(this.dCont, this.otstup, yyy+10,"b"))
    for (var i = 0; i < 3; i++) {
        this.array.push(this.bbb[i]= new DCheckBox(this.dCont, this.otstup+15+15+(wxz+this.otstup)*i, yyy," ", function(){
    ...
    this.array.push(new DLabel(this.dCont, this.otstup, yyy+10,"n"))
    ...
    this.array.push(new DLabel(this.dCont, this.otstup, yyy+10,"s"))
    ...
    for (var i = 0; i < this.array.length; i++) {
        ...
        if(this.array[i].height) this.array[i].height=this.elementsHeight
