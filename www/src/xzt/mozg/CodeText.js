...
export class CodeText extends DCont {
    constructor(dCont, _x, _y, _text,_fun) {
        ...
        this.dtagText = function(){
            var s=' <span style="color: #ff9999">этот текст зелёный</span>'


            this.dText.innerHTML = s//this.mzBlok.mzbText.textDrag.text; 
            this.divLit.innerHTML = s//this.mzBlok.mzbText.textDrag.text;            
            this.dtagText2();
        } 
